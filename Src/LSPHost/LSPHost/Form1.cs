        ...
        public static void taskSend()
        {
            while (Form1.running)
            {
                try
                {
                    ...
                    graphics.CopyFromScreen(0, 0, (width - System.Windows.Forms.Screen.PrimaryScreen.Bounds.Width) / 2, (height - System.Windows.Forms.Screen.PrimaryScreen.Bounds.Height) / 2, bmp.Size);
                    byte[] clientData;
                    clientData = ScreenToByteArray(bmp);
